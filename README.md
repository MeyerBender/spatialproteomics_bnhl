...
To see how you can apply `spatialproteomics` to your own data, please refer to the [official documentation](https://sagar87.github.io/spatialproteomics/notebooks/ExampleWorkflow.html).
